...
class TaskTable extends Component {
    ...
    //完成
    complete(key){
        this.props.completeTask && typeof this.props.completeTask === "function"  && this.props.completeTask(key);
    }

    //重做
    redo(key){
        this.props.redo && typeof this.props.redo === "function" && this.props.redo(key);
    }
    ...
    //编辑
    edit = (item) => {
        this.props.edit && typeof this.props.edit === "function"  && this.props.edit(item);
    }
    ...
    showDeleteConfirm(key){
        confirm({
            ...
            cancelText: '取消',
            onOk:() => {
                this.props.delete && typeof this.props.delete === "function" && this.props.delete(key);
            },
            onCancel(){ }
        })
    }
    ...
    render(){
        return(
            <div>
                ...
                <EditModal visible={this.state.formVisible} hideEditModal={this.hideEditModal} handleEdit={this.edit} 
